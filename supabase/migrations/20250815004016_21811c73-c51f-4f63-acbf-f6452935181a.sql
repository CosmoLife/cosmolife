-- Сначала удалим проблемные триггеры
...
-- Удалим старые функции которые используют net.http_post
DROP FUNCTION IF EXISTS public.notify_admins_new_investment();
DROP FUNCTION IF EXISTS public.notify_admins_new_share_sale();
