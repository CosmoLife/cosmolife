          ...
          {investments.map((investment) => (
            <div key={investment.id} className="bg-white/5 rounded-xl p-6 border border-white/10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  <p className="text-white"><strong>Пользователь:</strong> {investment.profiles?.full_name || 'Не указано'}</p>
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="w-full bg-white/5 border border-white/20 text-white rounded p-2"
                  >
        ...
        <TabsContent value="share-requests" className="space-y-4">
          ...
          {shareRequests.map((request) => (
            <div key={request.id} className="bg-white/5 rounded-xl p-6 border border-white/10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  <p className="text-white"><strong>Пользователь:</strong> {request.profiles?.full_name || 'Не указано'}</p>
