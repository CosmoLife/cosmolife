const Roadmap = () => {
  const roadmapItems = [
    ...
    },
    {
      period: "Осень 2025",
      title: "VINNI Factory",
      description: "Запуск VINNI Factory - фабрика по производству ИИ контента и размещение на наших аккаунтах в соцсетях. Мощный трафик с тысяч аккаунтов в социальных сетях. Цель: 10 млрд+ просмотров в месяц",
      status: "upcoming"
    },
    {
      period: "1-2 кв. 2026",
