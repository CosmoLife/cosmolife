const Roadmap = () => {
  const roadmapItems = [
    ...
    },
    {
      ...
      description: "Запуск тестовой MVP версии приложения для 5,000 ранних последователей. Клубная реферальная система с подпиской. Запуск игры VINNI GAME с матричной реферальной системой. Цель: 10,000+ участников",
      status: "upcoming"
    },
    {
      period: "Осень 2025",
      title: "VINNI Factory",
      description: "Запуск VINNI Factory - фабрика по производству вирусного ИИ контента с возможностью парсинга и анализа трендового топового контента в мире и размещение на наших аккаунтах в соцсетях. Мощный трафик с тысяч аккаунтов в социальных сетях. Цель: 10 млрд+ просмотров в месяц",
      status: "upcoming"
    },
    {
      period: "1-2 кв. 2026",
