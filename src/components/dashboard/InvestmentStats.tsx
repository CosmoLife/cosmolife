      ...
      {totalPercentage > 0 ? (
        <div className="glass-premium rounded-2xl p-6 border border-cosmo-blue/30 text-center bg-cosmo-blue/5">
          ...
          <p className="text-white/80 text-sm">
            Как инвестор с долей {totalPercentage.toFixed(4)}%, у вас есть доступ к закрытым видео о разработке VINNI. 
        ...
        <div className="glass-premium rounded-2xl p-6 border border-cosmo-green/30 text-center bg-cosmo-green/5">
          ...
          <p className="text-white/80 text-sm">
            После приобретения доли в проекте вы получите доступ к закрытым видео о разработке VINNI. 
